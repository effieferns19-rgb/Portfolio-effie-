    ...
    <>
      ...
      <section className="contact" id="contact" style={{ backgroundImage: 'url(/images/footer_sky.png)' }}>
        ...
        <div className="socials">
          ...
          <a href="https://www.linkedin.com/in/effie-fernandes-429b801b8/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" data-testid="footer-linkedin-link"><Linkedin size={24} /></a>
